...
public class Items {
    public ItemStack get(String name){
        if (name.equalsIgnoreCase("fill")){
            ...
            item.setItemMeta(meta);
            return item;
        } else if (name.equalsIgnoreCase("prisInv")){
            ItemStack item = new ItemStack(Material.CHEST);
            ItemMeta meta = item.getItemMeta();
            assert meta != null;
            meta.setDisplayName(ChatColor.DARK_AQUA + "" + ChatColor.BOLD + "Open Jailed Inventories");
            ArrayList<String> lore = new ArrayList<>();
            lore.add("");
            lore.add(ChatColor.GRAY + "Edit Inventories of prisoners");
            lore.add(ChatColor.GRAY + "before they were jailed.");
            lore.add("");
            meta.setLore(lore);
            item.setItemMeta(meta);
            return item;
            ...
            return confirmation;
        } else if (name.equalsIgnoreCase("smile2")){
            ItemStack confirmation = new ItemStack(Material.LIGHT_GRAY_STAINED_GLASS_PANE);
            ItemMeta confMeta = confirmation.getItemMeta();
            assert  confMeta != null;
            confMeta.setDisplayName(ChatColor.YELLOW + "" + ChatColor.MAGIC + "|" + ChatColor.YELLOW + ";)" + ChatColor.MAGIC + "|");
            ...
            confirmation.setItemMeta(confMeta);
            return confirmation;
        } else if (name.equalsIgnoreCase("confirmSolitary")){
            ItemStack confirmation = new ItemStack(Material.IRON_BARS);
            ItemMeta confMeta = confirmation.getItemMeta();
            assert  confMeta != null;
            confMeta.setDisplayName(ChatColor.WHITE + "" + ChatColor.BOLD + "Send Prisoner to Solitary");
            confirmation.setItemMeta(confMeta);
            return confirmation;
        }
        return null;
